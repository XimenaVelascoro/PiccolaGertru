...
var ObjectEntity = class extends ExpressionEntity {
  ...
  deoptimizeThisOnInteractionAtPath(interaction, path2, recursionTracker) {
    ...
    (interaction.type === INTERACTION_CALLED || path2.length > 1) && (this.hasUnknownDeoptimizedProperty || typeof key === "string" && this.deoptimizedPaths[key])) {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-7P4QZCM6.js");
...
rollup/dist/es/shared/rollup.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-YOSP4OSP.js.map
